...
public class MainActivity extends Activity implements OnClickListener {
	...
	private final String TURING_APIKEY = "89b9545895d84400b642f90ab471e742";
	/**
	 * 申请的secret
	 **/
	//private final String TURING_SECRET = "4145a1cb5f92901b";
	private final String TURING_SECRET = "60a4b18be9dc5caf";
	/**
	...
	private Handler mHandler = new Handler() {
		public void handleMessage(Message msg) {
			...
			case SPEECH_START:
				...
				mChoiceText.setText((String) msg.obj);
				break;
	...
	private RecognizerListener mRecognizerListener = new RecognizerListener() {
		...
		public void onResult(RecognizerResult results, boolean isLast) {
			...
			if (contentText != null && !"".equals(contentText.trim()) && contentText.length() > 1) {
				...
				mTuringApiManager.requestTuringAPI(contentText);
			} else {
				listening();
			}
			// }
